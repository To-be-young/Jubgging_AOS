...
import com.example.jubgging.databinding.ItemCommunityGroupBinding
...
class CommunityGroupPagingAdapter :
    PagingDataAdapter<CommunityGroup, CommunityGroupPagingAdapter.CommunityGroupViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CommunityGroupViewHolder {
        return CommunityGroupViewHolder(ItemCommunityGroupBinding.inflate(LayoutInflater.from(
            parent.context), parent, false))
    }

    inner class CommunityGroupViewHolder(
        val binding: ItemCommunityGroupBinding,
